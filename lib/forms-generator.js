...
Menu.prototype.render = function(jade, i18n, insertObj, jadeCode) {
  var menu = this.getContent(i18n);
  var opts = {
    'filename' : path.join(__dirname, "../jade", "null.jade"),
    '__menu' : menu,
    '__insertObj' : insertObj ? insertObj : {}
  };
  var code = jadeCode ? jadeCode : "";
...
Form.prototype.render = function(jade, i18n, insertObj, jadeCode) {
