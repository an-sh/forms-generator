...
function curry(fn, thisValue) {
  var args = Array.prototype.slice.call(arguments, 2);
  return function() {
    return fn.apply(thisValue ? thisValue : null,
                    args ? Array.prototype.concat(args, arguments) : args);
  };
}
...
function makeFieldClosure(fn, fieldData, i18n) {
  return function(cb) {
    return fn(fieldData, i18n, curry(cb, null, null));
  };
}
...
Form.prototype.validate = function(fields, files, i18n, nextOK, nextFAIL) {
  ...
  async.series(
    [
      ...
      function(cb) {
        if(form.globalValidator) {
          form.globalValidator(fields, files, i18n, curry(cb, null, null));
        } else {
          cb(null, null);
        }
      }
    ...
    function(fieldErrors, formError) {
      ...
      } else if(formError && formError[1] && formError[1][0]) {
        nextFAIL(null, formError[1][0]);
      } else {
        nextOK(fields, files);
      }
    }
